...
public class Administrar_Cartas extends javax.swing.JFrame {
    private BancoDeDados_Jogos bdCartas = new BancoDeDados_Jogos();
    private Jogo_Cartas cartas = new Jogo_Cartas();
    private boolean verificador = true;
    public Administrar_Cartas() {
        initComponents();
    }
    ...
    public void Limpar(){
        jTextField_ID.setText(Integer.toString(bdCartas.Verifica_ID(cartas)));
